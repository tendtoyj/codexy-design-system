...
/**
 * 채워진 정보-원 상태 아이콘. normal/info 중립 피드백용.
 * 원본: thoughts/icons (Name=circleInfoFill). 색은 currentColor 로 상속.
 */
export const InfoCircleFill = React.forwardRef<SVGSVGElement, React.SVGAttributes<SVGSVGElement>>(
  function InfoCircleFill({ width = "1em", height = "1em", ...props }, ref) {
    return (
      <svg
        ref={ref}
        width={width}
