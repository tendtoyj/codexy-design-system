...
import { DotsThree } from "@tendtoyj/cds-icons/icons";
...
const sidebarList = tv({
  slots: {
    ...
    header: [
      ...
      "data-[sticky=true]:bg-[var(--cds-background-normal-alternative,var(--cds-fill-normal))]",
    ],
    ...
    count: [
      ...
      "rounded-full bg-[var(--cds-fill-normal)]",
    ...
    item: [
      ...
      "data-[selected=true]:text-[color:var(--cds-label-normal)]",
    ...
    itemTrailing: [
      ...
      "opacity-0 transition-opacity duration-[var(--cds-duration-fast)]",
    ...
    more: [
      ...
      "transition-[background-color,color] duration-[var(--cds-duration-fast)]",
      "cursor-pointer select-none",
      "hover:bg-[var(--cds-fill-alternative)] hover:text-[color:var(--cds-label-alternative)]",
      "focus-visible:outline-none",
      "focus-visible:ring-2 focus-visible:ring-[color:var(--cds-focus-ring)] focus-visible:ring-offset-2",
      "focus-visible:ring-offset-[color:var(--cds-background-normal-normal)]",
    ],
