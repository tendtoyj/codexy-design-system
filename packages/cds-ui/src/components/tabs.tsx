...
const tabs = tv({
  slots: {
    ...
    trigger: [
      ...
      "focus-visible:ring-[color:var(--cds-focus-ring)] focus-visible:ring-offset-1",
  ...
  variants: {
    variant: {
      segmented: {
        list: "gap-[2px]",
        trigger: [
          "w-[24px] h-[24px] rounded-[var(--cds-radius-6)]",
          "[&>svg]:!w-[18px] [&>svg]:!h-[18px]",
          "text-[color:var(--cds-label-alternative)]",
          "hover:bg-[var(--cds-fill-normal)] hover:text-[color:var(--cds-label-neutral)]",
          "aria-selected:bg-[var(--cds-fill-strong)]",
          "aria-selected:text-[color:var(--cds-label-normal)]",
        ],
      },
      label: {
        list: "gap-[4px]",
        trigger: [
          "h-[28px] px-[8px] rounded-[var(--cds-radius-10)]",
