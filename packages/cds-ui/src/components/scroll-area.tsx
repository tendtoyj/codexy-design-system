...
const scrollArea = tv({
  slots: {
    ...
    scrollbar: [
      ...
      "data-[orientation=vertical]:h-full data-[orientation=horizontal]:flex-col data-[orientation=horizontal]:h-[var(--cds-sb-size)]",
      "data-[orientation=vertical]:w-[var(--cds-sb-size)]",
      "hover:[--cds-sb-size:10px]",
    ],
    thumb: [
      "relative flex-1 rounded-full",
      "bg-[color:color-mix(in_srgb,var(--cds-label-alternative)_45%,transparent)]",
      "before:absolute before:left-1/2 before:top-1/2 before:-translate-x-1/2 before:-translate-y-1/2",
      "before:h-full before:w-full before:min-h-[44px] before:min-w-[44px] before:content-['']",
      "transition-[background] ease-out hover:bg-[color:color-mix(in_srgb,var(--cds-label-alternative)_65%,transparent)]",
    ],
    corner: "bg-transparent",
  },
  variants: {
    scrollBarSize: {
      sm: { root: "[--cds-sb-size:6px]" },
      md: { root: "[--cds-sb-size:8px]" },
      responsive: { root: "[--cds-sb-size:6px]" },
    },
  },
  defaultVariants: {
    scrollBarSize: "md",
