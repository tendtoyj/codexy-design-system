 ...
 * import { Translate, Globe, CalendarCheck } from "@tendtoyj/cds-icons/icons";
 *
 * <Panel columns={3}>
...
const panel = tv({
  slots: {
    root: [
      ...
      "border border-[color:var(--cds-line-normal-alternative)]",
      "bg-[color:var(--cds-line-normal-alternative)]",
      "gap-px",
    ],
    cell: [
      "flex flex-col gap-[8px] min-w-0",
      "bg-[color:var(--cds-background-elevated-normal)]",
      "p-[20px]",
    ],
    cellHeader: [
...
const Panel = React.forwardRef<HTMLDivElement, PanelProps>(function Panel(
  ...
  return (
    <div
      ref={ref}
      data-cds-component="panel"
      data-cds-columns={columns}
