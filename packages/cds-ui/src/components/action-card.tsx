 ...
 * import { Compass, Check } from "@tendtoyj/cds-icons/icons";
 *
 ...
 * <ActionCard onClick={...}>
 *   <ActionCardLeading>
 *     <div className="w-[40px] h-[40px] rounded-[12px] bg-[var(--cds-fill-normal)] ...">
 *       {visual}
 *     </div>
 *   </ActionCardLeading>
...
const actionCard = tv({
  slots: {
    root: [
      ...
      "transition-[background-color,border-color] duration-[var(--cds-duration-fast)]",
    ...
    title: [
      ...
      "text-[color:var(--cds-label-strong)]",
    ],
    titleIcon: [
      "shrink-0 inline-flex items-center justify-center",
      "w-[16px] h-[16px]",
  ...
  variants: {
    variant: {
      outlined: {
        root: [
          "border border-[color:var(--cds-line-normal-normal)]",
          "bg-transparent",
          "hover:bg-[var(--cds-fill-alternative)]",
        ],
      },
      filled: {
        root: ["border-0", "bg-[var(--cds-fill-alternative)]", "hover:bg-[var(--cds-fill-normal)]"],
      },
      ghost: {
        root: ["border-0", "bg-transparent", "hover:bg-[var(--cds-fill-alternative)]"],
      },
    },
  },
  defaultVariants: {
...
const ActionCard = React.forwardRef<HTMLButtonElement, ActionCardProps>(function ActionCard(
  ...
  return (
    <Comp
      ref={ref}
      data-cds-component="action-card"
