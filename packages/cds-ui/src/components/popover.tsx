...
const popover = tv({
  slots: {
    content: [
      "z-[var(--cds-z-popover)] outline-none",
    ...
    title: "text-[13px] font-semibold text-[color:var(--cds-label-normal)] m-0",
    description: "text-[12px] text-[color:var(--cds-label-alternative)] m-0",
    body: "text-[13px] text-[color:var(--cds-label-normal)]",
    actionArea: "flex items-center justify-end gap-[8px] shrink-0",
    arrow: "fill-[var(--cds-background-elevated-normal)]",
  },
  variants: {
    size: {
      sm: {
