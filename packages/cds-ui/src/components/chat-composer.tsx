...
const chatComposer = tv({
  slots: {
    ...
    shell: [
      ...
      "rounded-[12px] border border-[color:var(--cds-line-normal-normal)]",
      "bg-[var(--cds-background-normal-normal)] shadow-[var(--cds-shadow-sm)]",
    ],
    field: [
      "w-full resize-none border-0 outline-none bg-transparent",
      "px-[14px] pt-[12px]",
      "text-[14px] leading-[20px] text-[color:var(--cds-label-normal)]",
      "placeholder:text-[color:var(--cds-label-assistive)]",
      "disabled:cursor-not-allowed disabled:text-[color:var(--cds-label-alternative)]",
    ],
    helper: "px-[14px] pt-[8px] text-[12px] leading-[18px] text-[color:var(--cds-label-assistive)]",
    error: "px-[14px] pt-[8px] text-[12px] leading-[18px] text-[color:var(--cds-status-negative)]",
    footer: "px-[14px] pt-[8px] text-[12px] leading-[18px] text-[color:var(--cds-label-assistive)]",
    toolbar: ["flex items-center justify-between gap-[12px]", "px-[10px] pt-[4px] pb-[10px]"],
    toolbarStart: [
      "flex items-center gap-[6px] min-w-0",
      "text-[12px] font-medium text-[color:var(--cds-label-normal)]",
    ],
    sendButton: [
      "inline-flex items-center justify-center shrink-0",
      "w-[24px] h-[24px] rounded-full border-0",
      "bg-[var(--cds-label-normal)] text-[color:var(--cds-inverse-label)]",
