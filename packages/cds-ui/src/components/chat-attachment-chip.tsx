...
import { File, X } from "@tendtoyj/cds-icons/icons";
...
const chatAttachmentChip = tv({
  slots: {
    root: [
      ...
      "rounded-full border border-[color:var(--cds-line-normal-normal)]",
      "bg-[var(--cds-background-normal-normal)]",
      "text-[12px] leading-[14px] text-[color:var(--cds-label-normal)]",
    ],
    leadingImageWrap: [
    ...
    remove: [
      ...
      "bg-[var(--cds-background-normal-normal)] text-[color:var(--cds-label-alternative)]",
      "hover:text-[color:var(--cds-label-normal)]",
      "opacity-0 pointer-events-none",
      "group-hover/attachment:opacity-100 group-hover/attachment:pointer-events-auto",
      "focus-visible:opacity-100 focus-visible:pointer-events-auto",
      "focus-visible:outline-none",
      "transition-[opacity,color] duration-[var(--cds-duration-fast)]",
