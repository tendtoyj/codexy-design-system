...
const tooltip = tv({
  slots: {
    content: [
      "z-[var(--cds-z-tooltip)] inline-flex items-center gap-[4px]",
      "bg-[var(--cds-background-elevated-normal)] text-[color:var(--cds-label-normal)]",
    ...
    shortcut: [
      ...
      "bg-[var(--cds-fill-normal)] text-[color:var(--cds-label-normal)]",
      "font-[var(--cds-font-mono)] tracking-wide",
