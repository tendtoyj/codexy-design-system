...
const removableTabBar = tv({
  slots: {
    ...
    tab: [
      ...
      "data-[active=true]:bg-[var(--cds-fill-normal)]",
    ],
    title: [
      "whitespace-nowrap truncate min-w-0 w-full",
      "text-[color:var(--cds-label-alternative)]",
      "group-data-[active=true]:text-[color:var(--cds-label-normal)]",
    ],
    close: [
  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          background: isActive
            ? "linear-gradient(var(--cds-fill-normal), var(--cds-fill-normal)), var(--cds-background-normal-normal)"
            : "linear-gradient(var(--cds-fill-alternative), var(--cds-fill-alternative)), var(--cds-background-normal-normal)",
        }}
        onClick={(event) => {
