...
const badge = tv({
  slots: {
    root: [
      ...
      "text-[color:var(--cds-badge-color)]",
    ],
  ...
  variants: {
    ...
    variant: {
      solid: {},
      outlined: {
        root: "bg-[var(--cds-background-normal-normal)]",
      },
    },
    color: {
      neutral: {},
  ...
  compoundVariants: [
    // solid: bg = badge-color @ 8% (neutral 만 fill.normal)
    {
      ...
      color: "accent",
      class: {
        root: "bg-[color:color-mix(in_srgb,var(--cds-badge-color)_8%,transparent)]",
      },
    },
    {
      variant: "solid",
    ...
    // outlined: border = badge-color @ 43% (neutral 만 line.normal.normal)
    {
      ...
      color: "accent",
      class: {
        root: "shadow-[inset_0_0_0_1px_color-mix(in_srgb,var(--cds-badge-color)_43%,transparent)]",
      },
    },
    {
      variant: "outlined",
      color: "neutral",
      class: {
        root: "shadow-[inset_0_0_0_1px_var(--cds-line-normal-normal)]",
      },
    },
  ],
  defaultVariants: {
...
const Badge = React.forwardRef<HTMLSpanElement, BadgeProps>(function Badge(
  ...
  const cssVars = {
    ["--cds-badge-color" as string]: `var(--cds-${tokenSuffix})`,
    ...style,
