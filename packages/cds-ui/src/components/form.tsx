...
const form = tv({
  slots: {
    ...
    label: [
      ...
      "text-[13px] font-medium text-[color:var(--cds-label-normal)]",
    ],
    description: "text-[12px] text-[color:var(--cds-label-alternative)]",
    error: ["text-[12px] text-[color:var(--cds-status-negative)]", "flex items-center gap-[4px]"],
    required: "text-[color:var(--cds-status-negative)]",
  },
  variants: {
    size: {
      sm: {
