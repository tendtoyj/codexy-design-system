...
const dialog = tv({
  slots: {
    overlay: [
      "fixed inset-0 z-[var(--cds-z-overlay)]",
      "bg-[var(--cds-material-dimmer)]",
      "data-[state=open]:animate-in data-[state=closed]:animate-out",
      "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ],
    content: [
      "fixed z-[var(--cds-z-modal)]",
      "bg-[var(--cds-background-elevated-normal)]",
      "border border-[var(--cds-line-normal-neutral)]",
      "shadow-[var(--cds-shadow-xl)]",
    ...
    title: "text-[15px] font-semibold text-[color:var(--cds-label-normal)] m-0",
    description: "text-[13px] text-[color:var(--cds-label-alternative)] m-0",
