...
const toast = tv({
  slots: {
    viewport: [
      "fixed z-[var(--cds-z-toast)] top-[16px] right-[16px] flex flex-col gap-[8px]",
    ...
    description: "text-[13px] leading-[18px] text-[color:var(--cds-label-alternative)] m-0",
    close: "absolute right-[10px] top-[10px]",
  },
  variants: {
    variant: {
      info: {
        icon: "text-[color:var(--cds-label-normal)]",
        title: "text-[color:var(--cds-label-normal)]",
      },
      success: {
        icon: "text-[color:var(--cds-color-blue-50)]",
        title: "text-[color:var(--cds-color-blue-50)]",
      },
      warning: {
        icon: "text-[color:var(--cds-status-cautionary)]",
        title: "text-[color:var(--cds-status-cautionary)]",
      },
      error: {
        icon: "text-[color:var(--cds-status-negative)]",
        title: "text-[color:var(--cds-status-negative)]",
      },
    },
  },
  defaultVariants: {
