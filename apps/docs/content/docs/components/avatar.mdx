---
title: Avatar
description: Radix Avatar + CDS 8단계 size, variant(person/company/academy)
---
...
fallback 아이콘은 `@tendtoyj/cds-icons/icons` 의 `User` / `Buildings` / `GraduationCap`.
...
```bash
npx shadcn add https://cds.codexy.com/r/avatar
```
