...
| Variant | 아이콘 | 토큰 |
|---|---|---|
| `info` | Info | `--cds-label-alternative` |
| `success` | CheckCircle2 | `--cds-status-positive` |
| `warning` | AlertTriangle | `--cds-status-cautionary` |
| `error` | AlertCircle | `--cds-status-negative` |
