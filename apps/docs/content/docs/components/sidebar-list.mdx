...
import { Plus, MagnifyingGlass, Funnel } from "@tendtoyj/cds-icons/icons";
...
import { IconButton } from "@tendtoyj/cds-ui/components/icon-button";
import { DotsThree, PencilSimple, Trash } from "@tendtoyj/cds-icons/icons";
...
```bash
npx shadcn add https://cds.codexy.com/r/sidebar-list
```
